      ...
      <>
        <div className={`min-h-screen overflow-x-hidden ${
          ...
          <div className="px-4 mt-8">
            ...
            <button
              className={`w-full p-6 rounded-2xl flex items-center justify-between border-2 transition-all shadow-lg ${
                resolvedTheme === 'dark'
            ...
            >
              <div className="flex items-center">
                <div className={`p-3 rounded-full mr-4 ${
                  resolvedTheme === 'dark' ? 'bg-[#724491]/20' : 'bg-[#724491]/10'
                }`}>
    ...
    <>
        ...
        >
          <div className="flex items-center gap-3">
            <div className="relative flex-1 group">
              ...
              <div className={`absolute -inset-1 rounded-3xl opacity-0 group-hover:opacity-100 group-focus-within:opacity-100 transition-opacity duration-300 blur-xl pointer-events-none ${
                resolvedTheme === 'dark' 
                  ? 'bg-primary/20' 
                  : 'bg-primary/10'
              }`} />
              
              <Search className={`absolute left-4 top-1/2 -translate-y-1/2 pointer-events-none z-10 w-5 h-5 transition-colors duration-150 ${
              ...
              <input
                ...
                className={`w-full rounded-2xl text-foreground placeholder:text-muted-foreground focus:outline-none relative py-3.5 pl-12 pr-10 text-sm transition-all duration-150 ${
                  resolvedTheme === 'dark' 
            ...
            >
              <Button
                ...
                className={`rounded-full h-12 w-12 p-0 relative overflow-hidden group flex-shrink-0 transition-all duration-200 ${
                  resolvedTheme === 'dark'
              ...
              >
                <UserCircle2 className={`w-7 h-7 ${
                  resolvedTheme === 'dark' ? 'text-primary-light' : 'text-primary'
                }`} />
              </Button>
            </div>
          </div>
      ...
      <div className="px-4 mt-8 space-y-8">
            ...
            {trendingItems.length > 0 ? (
              ...
              <div className={`flex items-center justify-center py-6 px-4 rounded-2xl border-2 border-dashed transition-all ${
                ...
                <TrendingUp className={`w-5 h-5 mr-3 ${
                  resolvedTheme === 'dark' ? 'text-orange-400/60' : 'text-orange-500/60'
                }`} />
        ...
        <ErrorBoundary>
          <section className="animate-slide-up-fade" style={{ animationDelay: '400ms' }}>
            ...
            {quickPickItems.length > 0 ? (
              ...
              <div className={`flex items-center justify-center py-6 px-4 rounded-2xl border transition-all ${
                resolvedTheme === 'dark' 
                ...
                <Zap className={`w-5 h-5 mr-3 ${
                  resolvedTheme === 'dark' ? 'text-blue-400/60' : 'text-blue-500/60'
                }`} />
                <span className={`text-sm font-medium ${
                  resolvedTheme === 'dark' ? 'text-blue-300/80' : 'text-blue-600/80'
                }`}>
        ...
        {!homeDataLoading && trendingItems.length === 0 && quickPickItems.length === 0 && categories.length === 0 && (
          <div className={`text-center py-8 px-6 rounded-3xl border-2 border-dashed transition-all animate-slide-up-fade ${
            resolvedTheme === 'dark' 
            ...
            <Button 
              ...
              variant="outline"
              size="default"
              className={`rounded-xl px-6 transition-all hover:scale-105 ${
                resolvedTheme === 'dark' 
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className="relative flex-1">
                <div 
                  className={`absolute -inset-0.5 rounded-xl opacity-0 focus-within:opacity-100 transition-opacity duration-300 blur-md pointer-events-none ${
