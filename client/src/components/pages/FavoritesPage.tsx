...
export default function FavoritesPage() {
  ...
  return (
    <>
      <div
        className={`w-full h-auto min-h-fit flex flex-col ${resolvedTheme === 'dark' ? 'bg-[#1a1a1a]' : 'bg-gray-50'
          }`}
      >
        {/* Header */}
                      ...
                      <CardContent className="p-0">
                        ...
                        <div className="flex items-center p-3">
                          ...
                          <div className="flex-1 min-w-0 flex flex-col justify-center">
                            <div className="flex items-center space-x-2 mb-1">
                              ...
                              <div
                                className={`w-3 h-3 rounded-sm flex items-center justify-center flex-shrink-0 ${item.isVegetarian ? 'bg-green-500' : 'bg-red-500'
                                  }`}
                                role="img"
                              ...
                              {/* Item name */}
                              <h3 className={`font-bold text-sm truncate leading-tight ${resolvedTheme === 'dark' ? 'text-gray-100' : 'text-gray-800'
                                }`}>
                          ...
                          <button
                            ...
                            className={`w-6 h-6 flex items-center justify-center transition-colors ${resolvedTheme === 'dark' ? 'text-gray-500 hover:text-red-400' : 'text-gray-400 hover:text-red-500'
                              }`}
                        ...
                        <div className="flex items-start justify-between p-3 pt-0">
                          ...
                          <div className="flex-1 min-w-0 pr-3">
                            <div className={`text-sm leading-tight truncate ${resolvedTheme === 'dark' ? 'text-gray-400' : 'text-gray-600'
                              }`}>
