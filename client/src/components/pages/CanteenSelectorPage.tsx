...
return (
    <div className={`min-h-screen ${resolvedTheme === 'dark' ? 'bg-background' : 'bg-gray-50'}`}>
        {/* Header Section */}
        <div className={`z-10 ${resolvedTheme === 'dark' ? 'bg-background/95' : 'bg-white/95'} backdrop-blur-md pb-4 pt-12 px-6`}>
            <div className="max-w-4xl mx-auto">
                ...
                <div
                    ...
                    className={`flex items-center gap-3 transition-all duration-300 ${isSearchSticky
                        ? `fixed top-0 left-0 right-0 z-40 px-4 py-3 backdrop-blur-lg shadow-sm ${resolvedTheme === 'dark'
        ...
        {/* Spacer when search bar is sticky */}
        {isSearchSticky && <div style={{ height: '60px' }} />}
        ...
        <div
            ...
            className={`px-4 mb-6 transition-all duration-300 ${isCategoriesSticky
                ? `fixed top-[60px] left-0 right-0 z-30 py-4 backdrop-blur-lg shadow-sm ${resolvedTheme === 'dark'
                    ? 'bg-background/95 border-b border-white/10'
                    : 'bg-white/95 border-b border-gray-200'
                }`
                : ''
        ...
        {/* Spacer when categories section is sticky */}
        {isCategoriesSticky && <div style={{ height: '120px' }} />}
