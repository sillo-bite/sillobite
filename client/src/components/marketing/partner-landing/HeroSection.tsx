...
export const HeroSection = () => {
  ...
  return (
    <section className="relative min-h-[60vh] bg-[#FFFBF7] overflow-hidden flex flex-col justify-center ">
      ...
      <div className="relative container mx-auto px-4 lg:mt-16 -z-1">
        ...
        <div className="text-center max-w-4xl mx-auto mb-[5vh]">
          ...
          >
            Streamline{" "}
            <span className="inline-flex items-center justify-center bg-[#9847D1] text-white px-4 h-[1.1em] lg:w-[8ch] w-[9ch]  lg:rounded-xl rounded-md align-middle overflow-hidden whitespace-nowrap">
        ...
        <motion.div
          ...
          className="relative max-w-5xl mx-auto mt-[5vh] mb-14"
        >
